...
const AfterpayLogo = () => {
  return (
    <button
      className="flex items-center afterpay-logo brand-afterpay compact-badge type-badge white-on-black"
    ...
    >
      <svg
        ...
        width="98"
        height="36"
        className="compact-badge-logo"
        viewBox="0 0 100 21"
      >
        <path
          className="afterpay-logo-badge-background"
          fill="#b2fce4"
